...
@implementation JobsCommentAppDelegate (Func)

static char *JobsCommentAppDelegate_Func_bitsMonitorSuspendLab = "JobsCommentAppDelegate_Func_bitsMonitorSuspendLab";
...
-(JobsBitsMonitorSuspendLab *)bitsMonitorSuspendLab{
    JobsBitsMonitorSuspendLab *BitsMonitorSuspendLab = objc_getAssociatedObject(self, JobsCommentAppDelegate_Func_bitsMonitorSuspendLab);
    if (!BitsMonitorSuspendLab) {
        ...
        objc_setAssociatedObject(self,
                                 JobsCommentAppDelegate_Func_bitsMonitorSuspendLab,
