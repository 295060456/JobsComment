...
//        window = [JobsCommentSceneDelegate sharedInstance].window;
...
static inline id getJobsIMSceneDelegate(){
    id JobsIMSceneDelegate = nil;
    if (@available(iOS 13.0, *)) {
        JobsIMSceneDelegate = UIApplication.sharedApplication.connectedScenes.allObjects.firstObject.delegate;
    }return JobsIMSceneDelegate;
}
